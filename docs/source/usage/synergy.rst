...
To optimize massive parallel computations across thousands of HPO pairs, **phenosyn** implements an adaptive permutation framework:
...
.. code-block:: python
    ...
    from phenosyn import SynergyAnalyzer
...
**phenosyn** provides built-in helper functions to generate common predicates.
...
.. code-block:: python
    ...
    from phenosyn import has_disease, has_sex, has_gene
...
.. code-block:: python
    ...
    from phenosyn import has_variant_effect
...
.. code-block:: python
    ...
    from phenosyn import has_exon_and_variant_effect
